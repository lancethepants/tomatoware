...
then
	...
	echo "sha256 3f429ea15b413373301a7fae45d452d4b941c5266f8a6bce0ea7f927ba0ad4e2 uClibc-ng-1.0.22.tar.xz" >> $BASE/toolchain/buildroot-2016.11/package/uclibc/uclibc.hash
	sed -i 's,1.0.20,1.0.22,g' $BASE/toolchain/buildroot-2016.11/package/uclibc/uclibc.mk
