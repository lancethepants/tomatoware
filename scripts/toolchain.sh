...
then
	...
	echo "sha256 2fdc6b9015f8049be0eb12a5e3e446de471fb80061115afd8d72ea582cb22b74 uClibc-ng-1.0.11.tar.xz" >> $BASE/toolchain/buildroot-2015.11/package/uclibc/uclibc.hash
