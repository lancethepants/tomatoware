...
then
	...
	echo "sha256 c7fd3e17bcfb8c3fd6963d16dbf9e3ce025c987fbfca38a1fe5a99c711eb1377 uClibc-ng-1.0.18.tar.xz" >> $BASE/toolchain/buildroot-2016.05/package/uclibc/uclibc.hash
