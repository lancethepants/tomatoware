...
then
	...
	echo "sha256 1c7e5cf82b034929edb9c7e584abfaf1c62fb087b64b73fcfc6315570690119a uClibc-ng-1.0.22.tar.xz" >> $BASE/toolchain/buildroot-2016.11/package/uclibc/uclibc.hash
