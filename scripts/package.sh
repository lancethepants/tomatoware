...
then
	...
	cp $BASE/src/setuptools/setuptools-1.3.1.tar.gz .
fi
...
echo "rm -rf setuptools-1.3.1" >> install_modules.sh
echo "tar zxvf setuptools-1.3.1.tar.gz" >> install_modules.sh
echo "cd setuptools-1.3.1/" >> install_modules.sh
